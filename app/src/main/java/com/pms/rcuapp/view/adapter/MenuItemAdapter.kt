...
class MenuItemAdapter(val context: Context, private val list: ArrayList<GetMenuListData>, private val onItemSelected: OnItemSelected<GetMenuListData>) :  RecyclerView.Adapter<MenuItemViewHolder>() {
